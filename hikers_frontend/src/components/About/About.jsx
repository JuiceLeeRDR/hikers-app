      ...
      <div className="about__cntnr">
        <div className="about__info-bg">
          ...
          <p className="about__text">
            ...
            Here, we attempt to help reconnect people with mother nauture and
            help these same people make new connections with likeminded
            individuals. So, find your trail, maybe even a buddy, and explore
            the world!
          </p>
          <p className="about__text about__text_bottom-text">
            Hike on, Hikers!
          </p>
        </div>
      </div>
